...
const API_KEYS = [
    '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',
    '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',
    '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',
    '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',
    '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'
];
...
async function queryOpenRouter(prompt, isMCQ = false) {
    ...
    const requests = API_KEYS.map(apiKey => 
        fetch(API_URL, {
            method: 'POST',
            headers: {
    ...
    try {
        // Race the promises - use the first successful response
